    ...
    <section className={cn('w-full overflow-hidden bg-background py-12 sm:py-24', className)}>
      <div className="container mx-auto grid grid-cols-1 items-center gap-12 lg:grid-cols-2 lg:gap-8">
        ...
        >
          ...
          >
            <img src={images[0]} alt="Hero asset primary" className="h-full w-full rounded-xl object-cover" />
          </motion.div>
          <motion.div
            ...
            variants={imageVariants}
          >
            <img src={images[1]} alt="Hero asset secondary" className="h-full w-full rounded-xl object-cover" />
          </motion.div>
          <motion.div
            ...
            variants={imageVariants}
          >
            <img src={images[2]} alt="Hero asset tertiary" className="h-full w-full rounded-xl object-cover" />
          </motion.div>
        </motion.div>
      </div>
    </section>
