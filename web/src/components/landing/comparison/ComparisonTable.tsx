...
const COMPARISON_DATA: ComparisonDimension[] = [
  {
    ...
    dotenv: 'Always (unencrypted)',
    hashi: 'Temp files or sidecars',
  },
  {
    feature: 'Setup & Footprint',
    vaultkey: 'Single binary, 0 dependencies',
    dotenv: 'None',
    hashi: 'Cluster & Consul required',
  },
  {
    feature: 'Team Sync',
    vaultkey: 'Encrypted sync (cloud or self-host)',
    dotenv: 'Manual (leaked in Git/Slack)',
    hashi: 'Complex IAM & tokens',
  },
  {
    feature: 'Offline Local Dev',
    vaultkey: 'Full offline execution',
    dotenv: 'Yes, but untracked',
    hashi: 'Requires local server',
  },
  {
    feature: 'License & Cost',
    vaultkey: 'Free open-source (MIT)',
    dotenv: 'Free (high breach risk)',
